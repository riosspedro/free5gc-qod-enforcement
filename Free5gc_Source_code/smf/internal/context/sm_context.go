...
func (c *SMContext) CreatePccRuleDataPath(pccRule *PCCRule,
	...
	logger.CtxLog.Infof("5g team This is the smcontext in cretepccdatapath [%+v]\n",c)
	logger.CtxLog.Infof("5g team This is the pccrule in [%+v]\n",pccRule)
	logger.CtxLog.Infof("5g team This is the qosData in [%+v]\n",qosData)
	...
	logger.CtxLog.Infof("5g team This is the param in [%+v]\n",param)
	...
	logger.CtxLog.Infof("5g team This is the datapath in [%+v]\n",createdDataPath)
