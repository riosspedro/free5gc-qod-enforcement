...
func BuildPDUSessionResourceModifyRequestTransfer(ctx *SMContext) ([]byte, error) {
	fmt.Errorf("In BuildPDUSessionResourceModifyRequestTransfer")
	...
	fmt.Errorf("Building PDU Session Modify Transfer: AdditionalQosFlows count: %d", len(ctx.AdditonalQosFlows))
