...
func (p *Processor) HandleSMPolicyUpdateNotify(
	...
	logAsJSON("5g team This is the decision", decision)
	logAsJSON("5g team This is the smcontext ", smContext)
	// logger.CtxLog.Infof("5g team This is the decision [%+v]\n", decision)
	// logger.CtxLog.Infof("5g team This is the smcontext [%+v]\n", smContext)
	if smContext == nil {
